		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Business Partner Enrich Form",
									"targetURL": "#bpmngmntnspworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bpmngmntnspworkflowuimodule-display": {
								"semanticObject": "bpmngmntnspworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bpmngmntnsp.workflowuimodule",
									"url": sap.ui.require.toUrl("bpmngmntnsp/workflowuimodule")
								}
							}
						}
					}
